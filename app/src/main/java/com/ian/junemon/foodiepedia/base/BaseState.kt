...
data class OnShowCategoryFood(val data: LiveData<List<LocalCategoryData>>?) : BaseState()
...
data class OnShowFilterData(val data: LiveData<List<LocalFilterData>>?) : BaseState()
