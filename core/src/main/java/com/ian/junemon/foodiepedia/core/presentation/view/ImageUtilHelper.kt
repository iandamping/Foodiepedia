...
interface ImageUtilHelper {
    ...
    fun openImageFromGallery(launcher: ActivityResultLauncher<Intent>)

    fun openImageFromCamera(launcher: ActivityResultLauncher<Intent>)

    fun getBitmapFromGallery(path: Uri): Bitmap?

    fun saveImage(views: View, bitmap: Bitmap?)

    fun saveImage(views: View, imageUrl: String?)
